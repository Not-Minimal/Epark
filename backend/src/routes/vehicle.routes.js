...
import { createVehicle, getVehicles, getVehicleByLicensePlate , getVehicleByOwnerId, updateVehicleByOwnerId ,updateVehicleByLicensePlate,getVehiclesByQuery} from "../controllers/vehicle.controller.js";
...
router.get("/getVehicleByLicensePlate/:LicensePlate",getVehicleByLicensePlate);
...
router.put("/updateVehicleByLicensePlate/:LicensePlate",updateVehicleByLicensePlate);
